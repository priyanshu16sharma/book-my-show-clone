      ...
      <HeroSlider>
        {images.map((images,index) => (
          <div className='w-full h-56 md:h-80 py-3' key={index}>
            <img src="{`https://image.tmdb.org/t/p/original${images.backdrop_path}`}" alt='Hero Banner' className='w-full h-full rounded-md object-cover'></img>
          </div>
        ))}
      </HeroSlider>
     </div>
     <div className='hiddeb lg:block'>
     <HeroSlider>
        {images.map((images,index) => (
